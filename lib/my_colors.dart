...
class SoildColor {
  ...
  static const Color sumbitArticle = Color.fromARGB(255, 209, 209, 209);
...
class GradientColor {
  ...
  static const List<Color> bottonNavBackground = [
    Color.fromARGB(255, 255, 255, 255),
  ...
  static const List<Color> homePosterCoverColor = [
